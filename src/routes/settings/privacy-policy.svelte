...
<div class="row">
  <div class="col">
    ...
    <p>
      ...
      and/or collect in ElectroBlocks. This policy is not applicable to any
      ...
      and the
      <a href="https://www.privacypolicies.com/privacy-policy-generator/">Free
    ...
    <p>
      ...
      <a href="https://www.cookieconsent.com/what-are-cookies/">"What Are
    ...
    <p>
      ...
      advertising partners of ElectroBlocks.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on ElectroBlocks, which are sent
